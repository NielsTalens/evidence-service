...
def handle_controls():
    ...
    return render_template("index.html", len_e = len(all_evidence), all_evidence = all_evidence, len_c = len(all_control), all_control = all_control, evidence=evidence, len_chf = len(checks_fail), controls_fail=controls_fail,len_chs = len(controls_succeed), controls_succeed=controls_succeed)
