...
try:
    ...
    insert_query = """ INSERT INTO evidence (rule_description, retrieved_value, retrieval_time) VALUES (%s, %s, %s)"""
    item_tuple = (rule_description, retrieved_value, retrieval_time)
